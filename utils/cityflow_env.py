...
class CityFlowEnv:
    ...
    def reset(self):
        ...
        # 创建frontend/web目录，确保CityFlow可以正确保存路网和回放日志
        os.makedirs(os.path.join(self.path_to_work_directory, "frontend", "web"), exist_ok=True)
